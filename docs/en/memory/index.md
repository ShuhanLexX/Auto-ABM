# AutoABM Memory System Documentation
...
### [03-autodream.md](./03-autodream.md) â€?AutoDream Memory Consolidation
...
All illustrations use a dark background (#1a1a2e) + AutoABM orange-blue accent (#FF7A00) style, consistent with the official Claude Code documentation.
...
- [AutoABM Home](/en/)
- [Memory system source code](https://github.com/SocialAI-X/Auto-ABM/tree/main/src/memdir/)
- [Auto-extraction service](https://github.com/SocialAI-X/Auto-ABM/tree/main/src/services/extractMemories/)
- [AutoDream service](https://github.com/SocialAI-X/Auto-ABM/tree/main/src/services/autoDream/)
- [DreamTask](https://github.com/SocialAI-X/Auto-ABM/tree/main/src/tasks/DreamTask/)
