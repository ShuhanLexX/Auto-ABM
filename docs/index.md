...
hero:
  name: AutoABM
  text: AI 原生应用框架
  tagline: LLM as CPU — 构建 AI 原生业务产品的底座系统
  image:
...
features:
  - icon: "\U0001F5A5"
    title: 完整 TUI 交互
    details: 基于 Ink 的终端界面，支持 --print 无头模式
  - icon: "\U0001F9E0"
    title: 记忆系统
  ...
  - icon: "\U0001F4AC"
    title: IM 接入
    details: 支持 Telegram / 飞书 / 微信 / 钉钉远程对话与审批
    link: /im/
  - icon: "\U0001F4BB"
    title: Computer Use
  ...
  - icon: "\U0001F5A5"
    title: 桌面端
    details: 基于 Electron + React 的图形化客户端，多标签、多会话、IM 适配器接入
    link: /desktop/
---
