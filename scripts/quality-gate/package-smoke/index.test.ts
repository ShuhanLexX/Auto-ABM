...
function writeAbmKernel(rootDir: string, unpackedResourcesDir: string) {
  const kernelDir = `${unpackedResourcesDir}/src-tauri/resources/abm-kernel`
  writeFile(rootDir, `${kernelDir}/pyproject.toml`)
  writeFile(rootDir, `${kernelDir}/src/abm_kernel/worker.py`)
  writeFile(rootDir, `${kernelDir}/.python/cpython-test/python.exe`)
  writeFile(rootDir, `${kernelDir}/.python/cpython-test/bin/python3`)
  writeFile(rootDir, `${kernelDir}/.venv/Lib/site-packages/mesa/__init__.py`)
  writeFile(rootDir, `${kernelDir}/.venv/lib/python3.13/site-packages/mesa/__init__.py`)
}
...
describe('packaged artifact inspection', () => {
  test('passes macOS bundle structure checks and records optional archive artifacts', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Info.plist')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/MacOS/AutoABM')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app-update.yml')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/dist/index.html')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/src-tauri/binaries/claude-sidecar-aarch64-apple-darwin')
    writeAbmKernel(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/package.json')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/pty.node')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/spawn-helper')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-arm64.zip')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-arm64.zip.blockmap')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-arm64.dmg')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-arm64.dmg.blockmap')
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest-mac.yml', [
      'version: 0.3.1',
      'files:',
      '  - url: AutoABM-0.3.1-arm64.zip',
      '  - url: AutoABM-0.3.1-arm64.dmg',
      'path: AutoABM-0.3.1-arm64.zip',
    ].join('\n'))
    ...
    expect(report.passedChecks.some((check) => check.label === 'macOS unpacked ABM kernel worker')).toBe(true)
    expect(report.passedChecks.some((check) => check.label === 'macOS unpacked ABM kernel Python runtime')).toBe(true)
    expect(report.passedChecks.some((check) => check.label === 'macOS unpacked ABM kernel Mesa dependency')).toBe(true)
  })
  ...
  test('fails macOS archive checks when latest-mac.yml points at missing assets', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/pty.node')
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/spawn-helper')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-arm64-mac.zip')
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest-mac.yml', 'path: AutoABM-0.3.1-missing.zip\n')
  ...
  test('fails release inspection when an update artifact blockmap is missing', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/mac-arm64/AutoABM.app/Contents/Resources/app.asar.unpacked/node_modules/node-pty/prebuilds/darwin-arm64/spawn-helper')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-arm64.zip')
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest-mac.yml', 'path: AutoABM-0.3.1-arm64.zip\n')
  ...
  test('treats Windows checks as static inspection on non-Windows hosts', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM Setup 0.3.1.exe')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM Setup 0.3.1.exe.blockmap')
    ...
    writeAbmKernel(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest.yml', 'path: AutoABM Setup 0.3.1.exe\n')
  ...
  test('passes Windows checks against the canonical build script output directory', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/windows-x64/AutoABM-0.3.1-x64.exe')
    writeFile(rootDir, 'desktop/build-artifacts/windows-x64/AutoABM-0.3.1-x64.exe.blockmap')
    ...
    writeAbmKernel(rootDir, 'desktop/build-artifacts/windows-x64/win-unpacked/resources/app.asar.unpacked')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/windows-x64/latest.yml', 'path: AutoABM-0.3.1-x64.exe\n')
    ...
    expect(report.passed).toBe(true)
    expect(normalizePathSeparators(report.artifactsDir).endsWith('desktop/build-artifacts/windows-x64')).toBe(true)
  })
  ...
  test('passes Windows directory-only checks for electron-builder --dir output', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/AutoABM.exe')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked/src-tauri/binaries/claude-sidecar-x86_64-pc-windows-msvc.exe')
    writeAbmKernel(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked')
    writeFile(rootDir, 'desktop/build-artifacts/electron/win-unpacked/resources/app.asar.unpacked/node_modules/node-pty/package.json')
  ...
  test('passes Linux checks against the canonical build script output directory', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/linux-x64/AutoABM-0.3.1-x64.AppImage')
    writeFile(rootDir, 'desktop/build-artifacts/linux-x64/AutoABM-0.3.1-x64.AppImage.blockmap')
    writeFile(rootDir, 'desktop/build-artifacts/linux-x64/autoabm-desktop_0.3.1_amd64.deb')
    ...
    writeAbmKernel(rootDir, 'desktop/build-artifacts/linux-x64/linux-unpacked/resources/app.asar.unpacked')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/linux-x64/latest-linux.yml', 'path: AutoABM-0.3.1-x64.AppImage\n')
    ...
    expect(report.passed).toBe(true)
    expect(normalizePathSeparators(report.artifactsDir).endsWith('desktop/build-artifacts/linux-x64')).toBe(true)
  })
  ...
  test('accepts Linux architecture-specific update metadata from arm64 builds', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/linux-arm64/AutoABM-0.3.1-arm64.AppImage')
    writeFile(rootDir, 'desktop/build-artifacts/linux-arm64/AutoABM-0.3.1-arm64.AppImage.blockmap')
    writeFile(rootDir, 'desktop/build-artifacts/linux-arm64/autoabm-desktop_0.3.1_arm64.deb')
    ...
    writeAbmKernel(rootDir, 'desktop/build-artifacts/linux-arm64/linux-unpacked/resources/app.asar.unpacked')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/linux-arm64/latest-linux-arm64.yml', 'path: AutoABM-0.3.1-arm64.AppImage\n')
  ...
  test('passes Linux release checks for Electron Builder output without AppImage blockmap', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-linux-x86_64.AppImage')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-linux-amd64.deb')
    ...
    writeAbmKernel(rootDir, 'desktop/build-artifacts/electron/linux-unpacked/resources/app.asar.unpacked')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest-linux.yml', 'path: AutoABM-0.3.1-linux-x86_64.AppImage\n')
  ...
  test('accepts Electron Builder linux-arm64-unpacked output directory', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-linux-arm64.AppImage')
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-linux-arm64.deb')
    ...
    writeAbmKernel(rootDir, 'desktop/build-artifacts/electron/linux-arm64-unpacked/resources/app.asar.unpacked')
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest-linux-arm64.yml', 'path: AutoABM-0.3.1-linux-arm64.AppImage\n')
    ...
    expect(report.passed).toBe(true)
    expect(report.passedChecks.some((check) => normalizePathSeparators(check.path).includes('linux-arm64-unpacked/resources/app.asar'))).toBe(true)
  })
  ...
  test('fails Linux release inspection without linux-unpacked static resources', async () => {
    ...
    writeFile(rootDir, 'desktop/build-artifacts/electron/AutoABM-0.3.1-x64.AppImage')
    writeFile(rootDir, 'desktop/build-artifacts/electron/latest-linux.yml', 'path: AutoABM-0.3.1-x64.AppImage\n')
