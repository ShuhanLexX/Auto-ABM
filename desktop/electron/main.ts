...
import { installTray, resolveTrayIconPath, shouldInstallTray, type TrayController } from './services/tray'
...
async function createMainWindow() {
  ...
  // The packaged Windows/macOS icon comes from the executable itself, but the
  // dev window and Linux taskbar need an explicit icon; fall back gracefully.
  let windowIcon: string | undefined
  try {
    windowIcon = resolveTrayIconPath(appRoot())
  } catch {
