...
export const zh: Record<TranslationKey, string> = {
  ...
  // ─── Sidebar ──────────────────────────────────────
  'sidebar.abmWorkbench': '模擬工作台',
  'sidebar.caseLibrary': '案例庫',
  ...
  'sidebar.blankProjectDialogTitle': '新建模擬目錄',
  'sidebar.blankProjectDialogBody': '將在預設 AutoABM 目錄下建立資料夾，並在其中開始研究會話。',
  'sidebar.blankProjectNameLabel': '目錄名稱',
  'sidebar.blankProjectNamePlaceholder': '市場群體行為實驗',
  'sidebar.createBlankProject': '建立專案',
  ...
  // ─── Settings ──────────────────────────────────────
  'settings.title': '設定',
  'settings.subtitle': '設定 AutoABM 工作區',
  ...
  'settings.terminal.description': '直接執行宿主機命令，用於安裝外掛、Skills、MCP 等擴充套件。桌面端已內建 autoabm；文件裡的 claude <引數> 可替換成 autoabm <引數>，例如 autoabm plugin install ... 或 autoabm mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '只會清理：autoabm-open-tabs、autoabm-session-runtime、autoabm-theme、autoabm-locale 和 autoabm.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/autoabm/settings.json — 直接編輯，儲存時寫入。',
  ...
  'settings.general.storagePortableDirPlaceholder': '選擇一個用於儲存 autoabm 資料的資料夾',
  ...
  'settings.general.storageMoveHint': '切換目錄不會自動搬遷舊資料。如果希望舊會話繼續出現，請把原目錄下的 projects、skills、plugins、autoabm 等資料複製到新目錄。要做便攜包，建議把目錄放在應用旁邊並一起壓縮。',
  ...
  'settings.general.notificationsTestTitle': 'AutoABM 通知已啟用',
  ...
  'settings.general.traceHintOn': '新會話會把精簡請求、回應、狀態事件寫入本機 autoabm traces 目錄。',
  ...
  'empty.subtitle': '自動化 Agent-Based Model 建模、實驗與發現',
  'empty.placeholder': '描述你想研究的現象或系統...',
  'empty.addFiles': '新增資料或論文',
  ...
  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': '讓 AutoABM 建模、運行、比較或解釋仿真...',
  ...
  'computerUseApproval.hideWhileWorking': 'AutoABM 工作時會隱藏另外 {count} 個應用。',
  'computerUseApproval.hideWhileWorkingRestore': 'AutoABM 工作時會隱藏另外 {count} 個應用，結束後會自動恢復。',
  ...
  'computerUseApproval.tryAgainHint': '“稍後重試”會把控制權交還給 AutoABM，讓它在 macOS 許可權生效後重新呼叫 request_access。',

  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'AutoABM 需要你的輸入',
