export const en = {
  ...
  // ─── Sidebar ──────────────────────────────────────
  'sidebar.abmWorkbench': 'Workbench',
  'sidebar.caseLibrary': 'Case Library',
  'sidebar.newSession': 'New research session',
  ...
  'sidebar.newSessionInProject': 'New research session in {project}',
  ...
  'settings.activity.defaultHandle': 'github.com/autoabm/autoabm',
  ...
  'settings.terminal.description': 'Run host-machine commands for plugin, skill, and MCP setup. The desktop app includes autoabm; replace documented claude <args> with autoabm <args>, for example: autoabm plugin install ... or autoabm mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'Clears only: autoabm-open-tabs, autoabm-session-runtime, autoabm-theme, autoabm-locale, and autoabm.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.autoabm/autoabm/settings.json — edit directly, will be written on save.',
  ...
  'settings.general.storageSystemDescription': 'Return to the default data source. If AUTOABM_CONFIG_DIR is set in the launch environment, that environment variable still takes priority.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'Choose a folder for autoabm data',
  ...
  'settings.general.storageEnvironmentHint': 'The current directory is controlled by the AUTOABM_CONFIG_DIR environment variable. In-app switching cannot override it; remove AUTOABM_CONFIG_DIR from the launch environment to return to the system directory.',
  'settings.general.storageEnvironmentSwitchBlocked': 'AUTOABM_CONFIG_DIR currently controls the data directory. Remove it from the launch environment before switching back to the system directory.',
  ...
  'settings.general.storageMoveHint': 'Switching directories does not migrate existing data. Copy projects, skills, plugins, autoabm, and related folders from the old directory if you want old sessions to keep appearing. For a portable bundle, keep this folder beside the app and zip them together.',
  ...
  'settings.general.notificationsTestTitle': 'AutoABM notifications are enabled',
  ...
  'settings.general.traceHintOn': 'New sessions write compact requests, responses, and status events to the local autoabm traces directory.',
  ...
  // ─── Empty Session ──────────────────────────────────────
  'empty.title': 'AutoABM · AI for Social Science',
  'empty.subtitle': 'Automate agent-based model design, experiments, and discovery',
  'empty.placeholder': 'Describe the phenomenon or system you want to study...',
  'empty.addFiles': 'Add data or papers',
  'empty.slashCommands': 'Slash commands',
  'empty.quick.code': 'Propose simulations',
  'empty.quick.app': 'Reproduce a model',
  'empty.quick.components': 'Parameter sweep',
  'empty.quick.theme': 'Mechanism attribution',
  'empty.quick.landing': 'Explain an interval',
  'empty.quick.docs': 'Model from data/paper',
  'empty.quick.assets': 'Export repro package',
  'empty.quick.codePrompt': 'I have an early research topic. Do not generate simulation proposals yet; first ask 4-7 questions to clarify the phenomenon, agents, interaction structure, space/network representation, data evidence, metrics, and experiment goals. After I answer, propose candidate simulations: ',
  'empty.quick.appPrompt': 'Reproduce this classic ABM model (e.g. SIR, Schelling, rumor spread) and explain the setup: ',
  'empty.quick.componentsPrompt': 'Run a single-parameter sweep over this parameter and compare the key metric across values: ',
  'empty.quick.themePrompt': 'Using the trace evidence chain, explain which mechanisms drove this result: ',
  'empty.quick.landingPrompt': 'Explain how the metrics change over this run interval, citing the trace evidence: ',
  'empty.quick.docsPrompt': 'Help me build an ABM model from this data/paper: ',
  'empty.quick.assetsPrompt': 'Export a reproduction package for this run (seed, parameters, model version, kernel version): ',
  ...
  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': 'Ask AutoABM to model, run, compare or explain...',
  ...
  'permission.planPreviewTitle': "AutoABM's plan",
  ...
  'permission.planFeedbackPlaceholder': 'Tell AutoABM what to change',
  ...
  'computerUseApproval.reason': 'Why AutoABM is asking',
  ...
  'computerUseApproval.hideWhileWorking': '{count} other apps will be hidden while AutoABM works.',
  'computerUseApproval.hideWhileWorkingRestore': '{count} other apps will be hidden while AutoABM works, then restored when AutoABM is done.',
  ...
  'computerUseApproval.tryAgainHint': 'Try again returns control to AutoABM so it can call request_access once more after macOS permission changes take effect.',

  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'AutoABM needs your input',
