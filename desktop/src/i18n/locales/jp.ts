...
export const jp: Record<TranslationKey, string> = {
  ...
  // ─── Sidebar ──────────────────────────────────────
  'sidebar.abmWorkbench': 'ワークベンチ',
  'sidebar.caseLibrary': 'ケースライブラリ',
  ...
  'sidebar.blankProjectDialogTitle': '新しいシミュレーションディレクトリ',
  'sidebar.blankProjectDialogBody': '既定の AutoABM ディレクトリにフォルダを作成し、そこで研究セッションを開始します。',
  'sidebar.blankProjectNameLabel': 'ディレクトリ名',
  'sidebar.blankProjectNamePlaceholder': '市場行動実験',
  'sidebar.createBlankProject': 'プロジェクトを作成',
  ...
  // ─── Settings ──────────────────────────────────────
  'settings.title': '設定',
  'settings.subtitle': 'AutoABM ワークスペースを設定',
  ...
  'settings.terminal.description': 'プラグイン、スキル、MCP のセットアップ用にホストマシンのコマンドを実行します。デスクトップアプリには autoabm が含まれています。ドキュメントの claude <args> を autoabm <args> に置き換えてください。例: autoabm plugin install ... や autoabm mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': 'クリアされるのは次のみ: autoabm-open-tabs、autoabm-session-runtime、autoabm-theme、autoabm-locale、autoabm.persistence.schemaVersion。',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/autoabm/settings.json — 直接編集できます。保存時に書き込まれます。',
  ...
  'settings.skills.description': 'スキルは AutoABM に専門的な機能を追加します。スキルは ~/.claude/skills/ で管理します',
  ...
  'settings.general.storagePortableDirPlaceholder': 'autoabm データ用のフォルダを選択',
  ...
  'settings.general.storageMoveHint': 'ディレクトリを切り替えても既存のデータは移行されません。以前のセッションを引き続き表示したい場合は、古いディレクトリから projects、skills、plugins、autoabm および関連フォルダをコピーしてください。ポータブルバンドルにする場合は、このフォルダをアプリの隣に置いて一緒に zip 化してください。',
  ...
  'settings.general.notificationsTestTitle': 'AutoABM の通知が有効になりました',
  ...
  'settings.general.traceHintOn': '新しいセッションは、簡潔な要求、応答、状態イベントをローカルの autoabm traces ディレクトリに書き込みます。',
  ...
  'empty.subtitle': 'エージェントベースモデルの設計・実験・発見を自動化',
  'empty.placeholder': '研究したい現象やシステムを説明してください...',
  'empty.addFiles': 'ファイルまたは写真を追加',
  'empty.slashCommands': 'スラッシュコマンド',
  'empty.quick.code': 'empty.quick.code',
  'empty.quick.app': 'empty.quick.app',
  'empty.quick.components': 'empty.quick.components',
  'empty.quick.theme': 'empty.quick.theme',
  'empty.quick.landing': 'empty.quick.landing',
  'empty.quick.docs': 'empty.quick.docs',
  'empty.quick.assets': 'empty.quick.assets',
  'empty.quick.codePrompt': 'empty.quick.codePrompt',
  'empty.quick.appPrompt': 'empty.quick.appPrompt',
  'empty.quick.componentsPrompt': 'empty.quick.componentsPrompt',
  'empty.quick.themePrompt': 'empty.quick.themePrompt',
  'empty.quick.landingPrompt': 'empty.quick.landingPrompt',
  'empty.quick.docsPrompt': 'empty.quick.docsPrompt',
  'empty.quick.assetsPrompt': 'empty.quick.assetsPrompt',
  ...
  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': 'AutoABM にモデル化、実行、比較、説明を依頼...',
  ...
  'computerUseApproval.reason': 'AutoABM が要求している理由',
  ...
  'computerUseApproval.hideWhileWorking': 'AutoABM の作業中、他の {count} 個のアプリが非表示になります。',
  'computerUseApproval.hideWhileWorkingRestore': 'AutoABM の作業中、他の {count} 個のアプリが非表示になり、AutoABM の完了後に復元されます。',
  ...
  'computerUseApproval.tryAgainHint': '再試行すると AutoABM に制御が戻り、macOS の権限変更が反映された後に request_access をもう一度呼び出せます。',

  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'AutoABM が入力を必要としています',
