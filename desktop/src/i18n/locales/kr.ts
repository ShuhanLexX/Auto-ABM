...
export const kr: Record<TranslationKey, string> = {
  ...
  // ─── Sidebar ──────────────────────────────────────
  'sidebar.abmWorkbench': '워크벤치',
  'sidebar.caseLibrary': '사례 라이브러리',
  ...
  'sidebar.blankProjectDialogTitle': '새 시뮬레이션 디렉터리',
  'sidebar.blankProjectDialogBody': '기본 AutoABM 디렉터리에 폴더를 만들고 그곳에서 연구 세션을 시작합니다.',
  'sidebar.blankProjectNameLabel': '디렉터리 이름',
  'sidebar.blankProjectNamePlaceholder': '시장 행동 실험',
  'sidebar.createBlankProject': '프로젝트 만들기',
  ...
  // ─── Settings ──────────────────────────────────────
  'settings.title': '설정',
  'settings.subtitle': 'AutoABM 워크스페이스 구성',
  ...
  'settings.terminal.description': '플러그인, 스킬, MCP 설정을 위해 호스트 컴퓨터의 명령을 실행합니다. 데스크톱 앱에는 autoabm가 포함되어 있습니다. 문서의 claude <args>를 autoabm <args>로 바꾸세요. 예: autoabm plugin install ... 또는 autoabm mcp add ...',
  ...
  'settings.diagnostics.doctorSafeKeys': '다음만 지웁니다: autoabm-open-tabs, autoabm-session-runtime, autoabm-theme, autoabm-locale, autoabm.persistence.schemaVersion.',
  ...
  'settings.providers.settingsJsonDesc': '~/.claude/autoabm/settings.json — 직접 편집할 수 있습니다. 저장 시 기록됩니다.',
  ...
  'settings.general.storagePortableDirPlaceholder': 'autoabm 데이터용 폴더 선택',
  ...
  'settings.general.storageMoveHint': '디렉터리를 전환해도 기존 데이터는 마이그레이션되지 않습니다. 이전 세션을 계속 표시하려면 이전 디렉터리에서 projects, skills, plugins, autoabm 및 관련 폴더를 복사하세요. 포터블 번들의 경우 이 폴더를 앱 옆에 두고 함께 압축하세요.',
  ...
  'settings.general.notificationsTestTitle': 'AutoABM 알림이 사용 설정되었습니다',
  ...
  'settings.general.traceHintOn': '새 세션은 간결한 요청, 응답, 상태 이벤트를 로컬 autoabm traces 디렉터리에 기록합니다.',
  ...
  'empty.subtitle': '에이전트 기반 모델 설계, 실험, 발견 자동화',
  'empty.placeholder': '연구하려는 현상이나 시스템을 설명하세요...',
  ...
  // ─── Chat Input ──────────────────────────────────────
  'chat.placeholder': 'AutoABM에 모델링, 실행, 비교, 설명을 요청...',
  ...
  'computerUseApproval.reason': 'AutoABM이 요청하는 이유',
  ...
  'computerUseApproval.hideWhileWorking': 'AutoABM이 작업하는 동안 다른 {count}개의 앱이 숨겨집니다.',
  'computerUseApproval.hideWhileWorkingRestore': 'AutoABM이 작업하는 동안 다른 {count}개의 앱이 숨겨졌다가 AutoABM이 완료되면 복원됩니다.',
  ...
  'computerUseApproval.tryAgainHint': '다시 시도하면 AutoABM에 제어가 돌아가 macOS 권한 변경이 적용된 후 request_access를 한 번 더 호출할 수 있습니다.',

  // ─── Ask User Question ──────────────────────────────────────
  'question.needsInput': 'AutoABM이 입력을 필요로 합니다',
