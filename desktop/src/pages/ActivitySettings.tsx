...
const DEFAULT_PROFILE: DesktopProfilePreferences = {
  displayName: 'autoabm',
  subtitle: 'github.com/SocialAI-X/Auto-ABM',
  avatarFile: null,
  ...
  return (
    <div className="mx-auto w-full max-w-[1060px] min-w-0 pb-12">
      <section className="relative flex min-h-[176px] flex-col items-center justify-start pt-4 text-center">
        <div className="relative flex h-16 w-16 items-center justify-center overflow-hidden rounded-full border border-[var(--color-border)] bg-[var(--color-surface-container-lowest)] shadow-[0_10px_28px_-22px_rgba(20,184,166,0.45)]">
          {profile.avatarFile ? (
            <img
              src={avatarSrc}
            ...
            <BrandMark size="lg" className="!h-14 !w-14 !rounded-full" />
          )}
        </div>
