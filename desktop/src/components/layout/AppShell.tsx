...
import { AppAmbientBackground } from '../ui/glass-composer-shell'
...
export function AppShell() {
  ...
  return (
    <div className={`app-shell app-shell-viewport lab-bg relative flex overflow-hidden bg-[var(--color-surface)]${isMobileShell ? ' app-shell--mobile' : ''}`}>
