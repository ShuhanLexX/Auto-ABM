...
export function ContextUsageIndicator({
  ...
  const useSheetDetails = compact && mobileViewport && !isDesktopRuntime()
  ...
  return (
    <div className="group/context relative pointer-events-auto">
      ...
      <div className={`pointer-events-none absolute bottom-full right-0 z-40 mb-2 w-[268px] max-w-[calc(100vw-2rem)] translate-y-1 rounded-[10px] border border-[var(--color-border)] bg-[var(--color-surface-container-lowest)] p-3 text-left opacity-0 shadow-[var(--shadow-dropdown)] transition-all duration-150 group-hover/context:translate-y-0 group-hover/context:opacity-100 group-focus-within/context:translate-y-0 group-focus-within/context:opacity-100 ${
        useSheetDetails ? 'hidden' : ''
      }`}>
        <div className="flex items-start justify-between gap-3">
          ...
          <div className="shrink-0 font-mono text-lg font-semibold text-[var(--color-text-primary)]">
