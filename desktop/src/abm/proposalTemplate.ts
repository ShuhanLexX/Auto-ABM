...
/** Map a proposal slug to a built-in kernel model family (server BUILTIN_TEMPLATES). */
export function inferTemplateFromProposal(proposal: Pick<AbmProposal, 'id' | 'mechanismSummary'>): string {
...
/** Pull seed/steps out of proposal keyParams; remainder becomes model parameters. */
