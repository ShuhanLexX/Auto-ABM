...
type CreateProjectDirectoryResponse = { name: string; workDir: string }
...
export const sessionsApi = {
  ...
  createResearchDirectory(name: string) {
    return api.post<CreateProjectDirectoryResponse>('/api/sessions/project-directory', { name })
  },
