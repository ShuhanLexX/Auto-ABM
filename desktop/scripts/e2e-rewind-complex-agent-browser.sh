...
SESSION_NAME="autoabm-rewind-complex-e2e-${RUN_ID}"
ARTIFACT_DIR="$(mktemp -d "/tmp/autoabm-rewind-complex-e2e-${RUN_ID}-XXXX")"
...
${AB} open "${WEB_URL}"
${AB} wait 2000
${AB} eval "localStorage.setItem('autoabm-locale', 'en'); location.reload();"
${AB} wait 2000
