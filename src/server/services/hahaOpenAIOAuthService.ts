...
</head><body><div class="card"><h1>OpenAI Login Successful</h1><p>You can close this window and return to AutoABM.</p></div>
...
export function getHahaOpenAIOAuthFilePath(): string {
  return path.join(appStateDir(), 'openai-oauth.json')
}
